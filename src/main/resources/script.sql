...
VALUES (SEQ_BRINQUEDOS.NEXTVAL, 'Hot Wheels', 'Carrinho', 10, 'Pequeno', 29.90);

INSERT INTO TDS_TB_BRINQUEDO (ID_BRINQUEDO, NM_BRINQUEDO, TP_BRINQUEDO, NR_CLASSIFICACAO, DS_TAMANHO, VL_PRECO)
VALUES (SEQ_BRINQUEDOS.NEXTVAL, 'LEGO Classic', 'Blocos de Montar', 6, 'Grande', 199.90);

INSERT INTO TDS_TB_BRINQUEDO (ID_BRINQUEDO, NM_BRINQUEDO, TP_BRINQUEDO, NR_CLASSIFICACAO, DS_TAMANHO, VL_PRECO)
VALUES (SEQ_BRINQUEDOS.NEXTVAL, 'Barbie Fashionista', 'Boneca', 3, 'Médio', 89.90);

INSERT INTO TDS_TB_BRINQUEDO (ID_BRINQUEDO, NM_BRINQUEDO, TP_BRINQUEDO, NR_CLASSIFICACAO, DS_TAMANHO, VL_PRECO)
VALUES (SEQ_BRINQUEDOS.NEXTVAL, 'Nerf Elite 2.0', 'Lançador', 8, 'Grande', 149.90);

INSERT INTO TDS_TB_BRINQUEDO (ID_BRINQUEDO, NM_BRINQUEDO, TP_BRINQUEDO, NR_CLASSIFICACAO, DS_TAMANHO, VL_PRECO)
VALUES (SEQ_BRINQUEDOS.NEXTVAL, 'Chocalho Elefante', 'Bebê', 0, 'Pequeno', 35.00);
